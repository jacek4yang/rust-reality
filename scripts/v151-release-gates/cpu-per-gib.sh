...
#
# v1.5.1: repository / xray / tmp-parent paths are parameterized (v150
# hardcoded the v150-gates worktree and artifacts/xray-reference):
#   RR_REPOSITORY  harness repository worktree (default worktrees/v151-gates)
#   XRAY_BIN       Xray client binary (default artifacts/xray-reference-v26.7.28)
#   GATES_TMP      existing scratch parent (default artifacts/v1.5.1/gates/tmp)
set -Eeuo pipefail
...
repository=${RR_REPOSITORY:-$ROOT/worktrees/v151-gates}
xray=${XRAY_BIN:-$ROOT/artifacts/xray-reference-v26.7.28}
gates_tmp=${GATES_TMP:-$ROOT/artifacts/v1.5.1/gates/tmp}
