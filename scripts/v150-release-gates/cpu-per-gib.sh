...
repository=/home/jacek/work/kimi-rust-reality-performance/worktrees/v150-gates
xray=/home/jacek/work/kimi-rust-reality-performance/artifacts/xray-reference
...
work=$(mktemp -d /home/jacek/work/kimi-rust-reality-performance/artifacts/v1.5.0/gates/tmp/cpu-per-gib.XXXXXX)
pids=()
cleanup() {
    set +e
