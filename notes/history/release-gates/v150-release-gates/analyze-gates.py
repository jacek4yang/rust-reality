...
def main() -> int:
    ...
    # Targeted high-sample re-check of the bimodal framed-download 1MiB c32
    # cell; merged into that cell's block ratios when present.
    matrix_rounds.append(GATES / "matrix-rcellcheck01")
