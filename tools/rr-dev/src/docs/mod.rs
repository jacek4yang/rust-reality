...
const REQUIRED_PAIRS: &[(&str, &str)] = &[
    ...
    (
        "docs/en/configuration/standalone.md",
        "docs/zh-CN/configuration/standalone.md",
    ),
    (
        "docs/en/configuration/users-and-credentials.md",
        "docs/zh-CN/configuration/users-and-credentials.md",
    ),
    (
        "docs/en/configuration/cover-targets.md",
        "docs/zh-CN/configuration/cover-targets.md",
    ),
    (
        "docs/en/configuration/outbounds.md",
        "docs/zh-CN/configuration/outbounds.md",
    ),
    (
        "docs/en/configuration/routing.md",
        "docs/zh-CN/configuration/routing.md",
    ),
    (
        "docs/en/configuration/line-landing.md",
        "docs/zh-CN/configuration/line-landing.md",
    ),
    (
        "docs/en/configuration/handoff.md",
        "docs/zh-CN/configuration/handoff.md",
    ),
    (
        "docs/en/configuration/multi-landing.md",
        "docs/zh-CN/configuration/multi-landing.md",
    ),
    (
        "docs/en/configuration/dns-and-network.md",
        "docs/zh-CN/configuration/dns-and-network.md",
    ),
    (
        "docs/en/configuration/runtime-and-resources.md",
        "docs/zh-CN/configuration/runtime-and-resources.md",
    ),
    (
    ...
    (
        ...
        "docs/zh-CN/operations/troubleshooting.md",
    ),
    (
