...
rr_crypto_curve25519_x25519_byte:
        .cfi_startproc
        sub sp, sp, #(384 +0) ; .cfi_adjust_cfa_offset 384
        stp d8, d9, [sp, #(224 +0)] ; .cfi_rel_offset d8, 224 ; .cfi_rel_offset d9, 232
        stp d10, d11, [sp, #(240 +0)] ; .cfi_rel_offset d10, 240 ; .cfi_rel_offset d11, 248
        stp d12, d13, [sp, #(256 +0)] ; .cfi_rel_offset d12, 256 ; .cfi_rel_offset d13, 264
        stp d14, d15, [sp, #(272 +0)] ; .cfi_rel_offset d14, 272 ; .cfi_rel_offset d15, 280
        stp x19, x20, [sp, #(288 +0)] ; .cfi_rel_offset x19, 288 ; .cfi_rel_offset x20, 296
        stp x21, x22, [sp, #(304 +0)] ; .cfi_rel_offset x21, 304 ; .cfi_rel_offset x22, 312
        stp x23, x24, [sp, #(320 +0)] ; .cfi_rel_offset x23, 320 ; .cfi_rel_offset x24, 328
        stp x25, x26, [sp, #(336 +0)] ; .cfi_rel_offset x25, 336 ; .cfi_rel_offset x26, 344
        stp x27, x28, [sp, #(352 +0)] ; .cfi_rel_offset x27, 352 ; .cfi_rel_offset x28, 360
        stp x29, x30, [sp, #(368 +0)] ; .cfi_rel_offset x29, 368 ; .cfi_rel_offset x30, 376
        str x0, [sp, #192]
        ldrb w10, [x1]
        ldrb w0, [x1, #1]
...
Lcurve25519_x25519_byte_scalarloop:
        ...
        cmp x0, x2
        str x2, [sp, #208]
        add v22.2s, v2.2s, v3.2s
        sub v21.2s, v28.2s, v1.2s
        add v25.2s, v0.2s, v1.2s
        sub v24.2s, v29.2s, v3.2s
        add v3.2s, v18.2s, v19.2s
        add v0.2s, v0.2s, v21.2s
        sub v20.2s, v29.2s, v15.2s
        sub v1.2s, v29.2s, v5.2s
        sub v26.2s, v28.2s, v11.2s
        sub v21.2s, v29.2s, v19.2s
        add v19.2s, v10.2s, v11.2s
        add v11.2s, v14.2s, v20.2s
        add v21.2s, v18.2s, v21.2s
        sub v20.2s, v29.2s, v17.2s
        add v18.2s, v2.2s, v24.2s
        add v14.2s, v14.2s, v15.2s
        add v15.2s, v16.2s, v17.2s
        add v2.2s, v16.2s, v20.2s
        add v24.2s, v12.2s, v13.2s
        add v26.2s, v10.2s, v26.2s
        sub v10.2s, v29.2s, v13.2s
        sub v13.2s, v29.2s, v7.2s
        add v23.2s, v6.2s, v7.2s
        sub v7.2s, v29.2s, v9.2s
        add v27.2s, v12.2s, v10.2s
        fcsel d20, d22, d24, eq
        add v28.2s, v4.2s, v5.2s
        fcsel d12, d23, d15, eq
        add v7.2s, v8.2s, v7.2s
        fcsel d16, d25, d19, eq
        mov x0, v20.d[0]
        fcsel d5, d28, d14, eq
        mov x21, v12.d[0]
        fcsel d29, d7, d21, eq
        ...
        and v8.16b, v27.16b, v30.16b
        add x28, x8, x8
        and v27.16b, v0.16b, v23.16b
        umaddl x8, w8, w23, x15
        and v5.16b, v24.16b, v23.16b
        ...
        umull x15, w19, w26
        usra v0.2d, v14.2d, #26
        add x6, x6, x22, lsr #25
        and v3.16b, v14.16b, v30.16b
        ...
        and v6.16b, v21.16b, v30.16b
        and x20, x8, #0x1ffffff
        and v5.16b, v18.16b, v23.16b
        add x17, x28, x29, lsl #4
        and v7.16b, v27.16b, v23.16b
        ldr x3, [sp, #128 +8]
        mov v22.s[1], w3
        lsr x3, x3, #32
        mov v23.s[1], w3
        ...
        lsr x3, x3, #32
        mov v15.s[1], w3
        and x12, x29, #0x1ffffff
        ldr x15, [sp, #32 +8]
        mov v22.s[0], w15
        lsr x15, x15, #32
        mov v23.s[0], w15
        add x28, x27, x8, lsr #26
        and v8.16b, v16.16b, v30.16b
        umull x1, w12, w10
        ldr x3, [sp, #128 +24]
        mov v17.s[1], w3
        lsr x3, x3, #32
        ...
        bfi x5, x3, #32, #25
        trn1 v17.4s, v13.4s, v27.4s
        add x19, x2, x29, lsr #26
        trn1 v19.4s, v21.4s, v28.4s
        and x3, x29, #0x3ffffff
        mov v16.d[0], v6.d[1]
        mov v6.d[0], v17.d[1]
        trn1 v8.4s, v8.4s, v9.4s
        bfi x3, x19, #32, #26
        and v21.16b, v11.16b, v30.16b
        bfi x23, x21, #32, #26
        mov v18.d[0], v8.d[1]
        mov v8.d[0], v19.d[1]
        ...
        and v27.16b, v25.16b, v23.16b
        bfi x17, x7, #32, #25
        mov v5.d[0], x3
        mov v1.d[0], x5
        usra v26.2d, v20.2d, #26
        and v28.16b, v20.16b, v30.16b
        trn1 v11.4s, v21.4s, v27.4s
...
Lcurve25519_x25519_byte_invmidloop:
        ...
        lsr x13, x13, #8
        strb w13, [x17, #31]
        ldp d8, d9, [sp, #(224 +0)] ; .cfi_restore d8 ; .cfi_restore d9
        ldp d10, d11, [sp, #(240 +0)] ; .cfi_restore d10 ; .cfi_restore d11
        ldp d12, d13, [sp, #(256 +0)] ; .cfi_restore d12 ; .cfi_restore d13
        ldp d14, d15, [sp, #(272 +0)] ; .cfi_restore d14 ; .cfi_restore d15
        ldp x19, x20, [sp, #(288 +0)] ; .cfi_restore x19 ; .cfi_restore x20
        ldp x21, x22, [sp, #(304 +0)] ; .cfi_restore x21 ; .cfi_restore x22
        ldp x23, x24, [sp, #(320 +0)] ; .cfi_restore x23 ; .cfi_restore x24
        ldp x25, x26, [sp, #(336 +0)] ; .cfi_restore x25 ; .cfi_restore x26
        ldp x27, x28, [sp, #(352 +0)] ; .cfi_restore x27 ; .cfi_restore x28
        ldp x29, x30, [sp, #(368 +0)] ; .cfi_restore x29 ; .cfi_restore x30
        add sp, sp, #(384 +0) ; .cfi_adjust_cfa_offset -384
        ret ; .cfi_endproc
