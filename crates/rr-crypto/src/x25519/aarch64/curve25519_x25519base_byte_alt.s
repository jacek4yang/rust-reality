...
rr_crypto_curve25519_x25519base_byte_alt:
        ...
        ldr x0, [sp, #(0*32)]
        ands xzr, x0, #8
        adrp x19, rr_crypto_curve25519_x25519base_byte_alt_constant
        add x19, x19, :lo12:rr_crypto_curve25519_x25519base_byte_alt_constant
        ldp x0, x1, [x19]
        ldp x2, x3, [x19, #96]
        csel x0, x0, x2, eq
        csel x1, x1, x3, eq
        ...
        add x19, x19, #192
        mov x21, xzr
Lcurve25519_x25519base_byte_alt_scalarloop:
        lsr x0, x20, #6
        ldr x2, [sp, x0, lsl #3]
        lsr x2, x2, x20
        and x2, x2, #15
        ...
        mov x21, #0xa
        mov x22, #0x1
        b Lcurve25519_x25519base_byte_alt_invmidloop
Lcurve25519_x25519base_byte_alt_invloop:
        cmp x10, xzr
        csetm x14, mi
        cneg x10, x10, mi
        cmp x11, xzr
        ...
        stp x0, x1, [sp, #96]
        stp x3, x2, [sp, #112]
Lcurve25519_x25519base_byte_alt_invmidloop:
        mov x1, x22
        ldr x2, [sp]
        ldr x3, [sp, #32]
        and x4, x2, #0xfffff
        ...
        mov x22, x1
        subs x21, x21, #0x1
        b.ne Lcurve25519_x25519base_byte_alt_invloop
        ldr x0, [sp]
        ldr x1, [sp, #32]
        mul x0, x0, x10
        madd x1, x1, x11, x0
        ...
        ret ; .cfi_endproc
.size rr_crypto_curve25519_x25519base_byte_alt, .-rr_crypto_curve25519_x25519base_byte_alt
.section .note.GNU-stack, "", %progbits
.section .rodata
.type rr_crypto_curve25519_x25519base_byte_alt_constant, %object
.size rr_crypto_curve25519_x25519base_byte_alt_constant, 48576
rr_crypto_curve25519_x25519base_byte_alt_constant:
